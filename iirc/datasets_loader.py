...
datasets_names = ["incremental_cifar100", "iirc_cifar100","my_iirc_cifar100", "incremental_imagenet_full", "incremental_imagenet_lite",
                  "iirc_imagenet_full", "iirc_imagenet_lite", "iirc_imagenet_subset"]
...
def _get_tasks_configuration(dataset_name: str, tasks_configuration_id: int = 0, joint: bool = False) -> Tuple[
    ...
    if dataset_name == "iirc_cifar100":
        ...
        assert 0 <= tasks_configuration_id <= 4
    #################################################
    elif dataset_name == "iirc_imagenet_subset":
        tasks_file = os.path.join(metadata_root, "iirc_imagenet_subset_task_configurations.json")
        assert 0 <= tasks_configuration_id <= 10
    #################################################
