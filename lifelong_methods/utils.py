...
def get_optimizer(model_parameters: Iterator[nn.parameter.Parameter], optimizer_type: str = "momentum",
                  ...
                  reduce_lr_on_plateau: bool = False, weight_decay: float = 0.0001, patience=15) -> Tuple[
    ...
    if reduce_lr_on_plateau:
        ############# patience might be too small in some casees
        scheduler = ReduceLROnPlateau(optimizer, mode='max', factor=lr_gamma, patience=patience, verbose=True, threshold=1e-3,
                                      threshold_mode="abs")
